...
// struct that implements the translator interface.
// This calls existing snmptranslate command
...
func (n *netsnmpTranslator) execCmd(arg0 string, args ...string) ([]byte, error) {
	...
	slog.Debug("executing "+arg0, "arg", strings.Join(quoted, " "))
...
// function-result-limit conditionally 5 return results allowed
